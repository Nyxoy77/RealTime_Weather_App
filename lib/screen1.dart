...
class _WeatherAppState extends State<WeatherApp> {
  ...
  Widget build(BuildContext context) {
    ...
    const border = OutlineInputBorder(
      ...
      borderSide: BorderSide(width: 2, strokeAlign: BorderSide.strokeAlignCenter,color: Colors.grey),
      ...
      body: FutureBuilder<Map<String,dynamic>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(child: CircularProgressIndicator.adaptive());// This will change the indicator bases on ios / android);
                            ...
                            children: [
                              ...
                              for(int i =0;i<6;i++)
                               ...
                               HourlyForecast(
                                ...
                                icon: data['list'][0]['weather'][0]['main']=='Clouds' || data['list'][0]['weather'][0]['main']=='Rain'?Icons.cloud:Icons.sunny,
                                time: data['list'][i+1]['dt_txt'].toString().substring(12,16), // or use a package knowns as intl
